<x-layout>
    ...
    <div class="container-fluid p-5 text-center">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="display-1 fontCorsive">Modifica l'articolo</h1>
                <h2 class="display-3 fontCorsive">"{{$article->title}}" </h2>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <form action="{{route('article.update', $article)}} " method="POST" class="card p-5 shadow" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label"> Nuova immagine Attuale</label>
                    ...
                    <div class="mb-3">
                        ...
                        <span class="small text-muted fst-italic">Separa ogni tag con una virgola</span>
                        @error('tags')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
