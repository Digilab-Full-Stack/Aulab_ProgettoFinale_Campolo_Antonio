...
<div class="container-fluid p-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-6 ">
            <form action="{{route('article.store')}}" method="POST" class="card p-5 bg-secondary bg-opacity-75 border border-warning  border-5 border-opacity-25 rounded-5" enctype="multipart/form-data"> 
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <span class="small  fst-italic fw-bold text-white">Separa ogni tag con una virgola</span>
                    @error('tags')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                <div class="mt-3 d-flex justify-content-center flex-column align-items-center ">
                    <button type="submit" class="btn btn-warning btn-outline-danger">Inserisci articolo</button>
